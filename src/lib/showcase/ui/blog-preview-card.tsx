import BlogPreviewCard from '@/components/home/blog-preview-section/blog-preview-card';
...
export const blogPreviewCardShowcase = defineShowcase({
  ...
  description: 'Linked article card with reading time, title, excerpt, and call to action.',
  importPath: '@/components/home/blog-preview-card',
  status: 'stable',
  metadataDescription: 'Blog preview card with reading time, title, excerpt, and hover states.',
  groups: [
  ...
  usage: [`import BlogPreviewCard from "@/components/home/blog-preview-card";\n\n<BlogPreviewCard post={post} />`],
});
